    ...
    <>
      ...
      >
        <ScrollLink to="home" smooth={true} duration={500}>
          <img src="/tp.svg" alt="trustopay logo" width={170} height={170} />
        </ScrollLink>
        <HiOutlineMenuAlt4
          onClick={() => setToggle(true)}
          className="w-8 h-8 text-xl text-black cursor-pointer"
        />
      </div>
      <AnimatePresence mode="wait">
        {toggle && (
          <motion.div
            ...
            className="fixed top-0 bottom-0 right-0 z-50 flex flex-col items-end justify-end w-full min-h-screen text-white bg-black bg-secondry"
          >
