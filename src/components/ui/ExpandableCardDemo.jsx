...
export function ExpandableCardDemo() {
  ...
  return (
    <>
        ...
        {active ? (
          <div className="fixed inset-0 grid place-items-center z-[100] p-4">
            ...
            <motion.div
              layoutId={`card-${active.title}-${id}`}
              ref={ref}
              className="w-full max-w-[500px] max-h-screen flex flex-col bg-white dark:bg-neutral-900 sm:rounded-3xl overflow-hidden"
            >
              <motion.div layoutId={`image-${active.title}-${id}`}>
                <img
                  width={500}
                  ...
                  src={active.src}
                  alt={active.title}
                  className="object-cover object-center w-full h-80 sm:rounded-t-lg"
                />
              </motion.div>
              ...
              <div className="p-4">
                ...
                <div className="relative mt-4 overflow-y-auto max-h-[250px] pr-2 scrollbar-hide">
                  <motion.div
                    layout
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                    exit={{ opacity: 0 }}
                    className="text-xs text-neutral-600 md:text-sm lg:text-base dark:text-neutral-400"
                  >
                    {typeof active.content === "function"
                      ? active.content()
                      : active.content}
      ...
      <ul className="flex flex-col w-full max-w-screen-lg gap-4 mx-auto">
        {cards.map((card) => (
          <motion.div
            layoutId={`card-${card.title}-${id}`}
            key={`card-${card.title}-${id}`}
            ...
            <div className="flex flex-col items-center gap-4 md:flex-row">
              ...
              >
                <img
                  ...
                  src={card.src}
                  alt={card.title}
                  className="object-cover object-center w-40 h-40 rounded-lg md:h-14 md:w-14"
                />
              </motion.div>
...
const cards = [
  {
    ...
    content: () => (
      <p>
        Lana Del Rey, an iconic American singer-songwriter, is celebrated for
        her melancholic and cinematic music style. <br /> <br />
        Her songs often explore themes of tragic romance, glamour, and
  ...
  },
  {
    ...
    content: () => (
      <p>
        ...
        and profound lyrics that resonate deeply with his audience. <br />
        <br />
        His songs often reflect the struggles and triumphs of everyday life.
      </p>
    ),
