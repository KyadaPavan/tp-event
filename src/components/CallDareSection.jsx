      ...
      <div className="flex flex-col w-full h-full md:flex-row">
        ...
        >
          <div className="relative flex items-center h-full px-10 md:px-20">
            <h1 className="px-4 py-6 text-3xl font-semibold leading-tight text-[#6423C4] rounded-md md:py-4 lg:text-6xl bg-white/50 backdrop:blur-lg">
        ...
        <div className="flex items-center w-full px-6 py-10 shadow-xl bg-white/30 backdrop-blur-md md:w-1/2 md:px-16">
          <div className="w-full space-y-6">
            {[
              ...
              <div key={index} className="pb-4 border-b border-[#D99BFF]">
          ...
          <div className="absolute -top-40  -right-10 w-[60%] mx-auto h-[70%] bg-gradient-to-r from-[#6423C4] via-[#C358F4] to-[#CA8FFD] opacity-20 blur-3xl my-auto rounded-full"></div>
        </div>
      </div>
    </section>
  );
